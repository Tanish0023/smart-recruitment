    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="md:hidden text-gray-600 hover:text-indigo-600 p-2"
      ...
      {mobileMenuOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -20 }}
          className="md:hidden absolute top-full left-0 right-0 bg-white shadow-xl border-t border-gray-100 py-4"
        >
