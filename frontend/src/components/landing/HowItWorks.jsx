      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-3xl p-8 border border-indigo-100/50 shadow-2xl relative">
              ...
              <div className="mt-8 space-y-4">
                <div className="h-8 bg-white rounded flex items-center px-4 w-1/3 shadow-sm">
                   <div className="h-3 bg-gray-200 rounded w-full"></div>
                </div>
                
                {[98, 92, 85, 78].map((score, i) => (
                  <div key={i} className="bg-white p-4 rounded-xl flex items-center justify-between shadow-sm hover:-translate-y-1 transition-transform cursor-pointer">
